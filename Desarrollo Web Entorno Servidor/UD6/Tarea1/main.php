...
<main class="main">
    <?php
    $calle = (isset($_POST["calle"]) ? htmlentities(addslashes($_POST["calle"])) : "dato no encontrado");
    $numero = (isset($_POST["numero"]) ? htmlentities(addslashes($_POST["numero"])) : "dato no encontrado");
    $poblacion = (isset($_POST["poblacion"]) ? htmlentities(addslashes($_POST["poblacion"])) : "dato no encontrado");
    $pais = (isset($_POST["pais"]) ? htmlentities(addslashes($_POST["pais"])) : "dato no encontrado");
    ?>
