...
try {
    match ($_POST["pag"]) {
        ...
        "1", "2", "3", "4", "5", "6", "7", "8" => ControladorActores::vistaInfoTemporadas($_POST["pag"]), //        "Todas" => ControladorActores::vistaInfoTemporadas("*"),
        ...
        default => ControladorActores::vistaError("Error al intentar acceder a la página:  Llegó la opción pero ninguna era válida"),
    };
} catch (Exception $e) {
    ControladorActores::vistaError("Error al intentar acceder a la página. Info: " . $e->getMessage());
    die();
}
